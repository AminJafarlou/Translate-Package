...
function generate() {
    return __awaiter(this, void 0, void 0, function () {
        var configString, config, source, sourceLanguage;
        var _this = this;
        return __generator(this, function (_a) {
            ...
            config.languages.forEach(function (language) { return __awaiter(_this, void 0, void 0, function () {
                var fileName, isFileExisting, enObj, remainingKeys, inputObject, reducer, i, slicedObj, result, finalResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fileName = language + ".js";
                            isFileExisting = fs_1.default.existsSync(path_1.default.resolve(config.out, fileName));
                            enObj = isFileExisting
                                ? require(path_1.default.resolve(config.out, fileName))
                                : {};
                            remainingKeys = Object.keys(source).filter(function (key) { return !Object.keys(enObj).includes(key); });
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 1];
                        case 4:
                            finalResult = Object.assign(reducer, enObj);
