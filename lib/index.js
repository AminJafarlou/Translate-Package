        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isOldSourceExisting = fs_1.default.existsSync(path_1.default.resolve(config.out + "/oldSource.js"));
                    oldSource = isOldSourceExisting
                        ? require(path_1.default.resolve(config.out + "/oldSource.js"))
                        : {};
                    ...
                    return [4 /*yield*/, fs_1.default.copyFileSync(config.source, config.out + "/oldSource.js")];
                case 1:
                    // Make a copy of source file for future comparisons
                    _a.sent();
                    return [2 /*return*/];
